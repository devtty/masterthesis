...
Die praktisch einfachste Web Application Firewall wäre -beispielsweise- eine einfache Regel innerhalb der Webserver-Konfiguration, die anhand eines bestimmten Merkmals den Datenverkehr entweder korrekt beantwortet oder \glqq\emph{abwehrt}\grqq. Der unter \ref{fig:httprule} sichtbare Eintrag findet sich in 
