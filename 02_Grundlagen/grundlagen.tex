...
Bei dieser \emph{Sicherheitsregel} wird die \emph{aufgerufene Adresse} (REQUEST_URI VARIABLE) auf \emph{Übereinstimmung mit einem regulären Ausdruck} (.ht OPERATOR) geprüft und bei Übereinstimmung die Ausführung \emph{verweigert} (deny ACTIONS).
