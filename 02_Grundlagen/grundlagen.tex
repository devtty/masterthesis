...
\textcolor{bhtGray}{\ding{110} Definition\footnote{https://owasp.org/www-community/Web_Application_Firewall} A web application firewall is an application firewall for HTTP applications. It applies a set of rules to an HTTP Conversation. Generally, these rules cover common attacks such as Cross-site Scripting (XSS) and SQL Injection.\\While proxies protect\\\\
