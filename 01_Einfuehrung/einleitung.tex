...
Jährlich erscheint mit den OWASP Top Ten~\cite{owasp10}  eine Liste der meist ausgenutzten und bekannten Sicherheitsrisiken für Webanwendungen. In den meisten Fällen wird eine Anwendung sehr individuell gegen solche Risiken abgesichert und häufig wird dabei auch jedes einzelne Risiko separat adressiert. \\
...
\textcolor{bhtGray}{\ding{110} These:} Eine Anwendung lässt sich auch mit genügend zur Verfügung stehenden Daten von ähnlichen Anwendungen absichern!

Zum Teil basiert die Arbeit auf Vorarbeiten im Bereich der Anwendungssicherheit, die im Kapitel \glqq\emph{Grundlagen}\grqq{} näher vorgestellt werden. 
