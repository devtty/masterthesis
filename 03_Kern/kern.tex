...
%  \resizebox{\textwidth}{!}{ 
  \begin{tabular}{|l | l | l | l | l | l |}
    ...
    \hline
    HTTP Methode & \verb=GET= oder \verb=POST= im Anomalieteil auch \verb=PUT= & & 2 & 2 & 3\\
    URL & & & 28 & 28 & 1623\\
    Protocol & \verb=HTTP/1.1= & HTTP/2 & 1 & 1 & 1\\
    User-Agent & \verb=Mozilla/5.0 (compatible;Konqueror/3.5...= & & 1 & 1 & 1\\
    \emph{Pragma} & \verb=no-cache= & & 1 & 1 & 1\\
    \emph{Cache-control} & \verb=no-cache= & & 1 & 1 & 1\\
    \emph{Accept} & \verb=text/xml,application/xml,...= & & 1 & 1 & 1\\
    \emph{Accept-Encoding} & \verb=x-gzip,x-deflate,gzip,deflate= & & 1 & 1 & 1\\
    \emph{Accept-Charset} & \verb!utf-8,utf-8;q=0.5,*;q=0.5! & & 1 & 1 & 1\\
    \emph{Accept-Language\ & \verb=en= & & 1 & 1 & 1\\
    Host & \verb=localhost:8080= & & 1 & 1 & 2\\
    Cookie & \verb=JSESSIONID= verschiedene Werte & & & \\
    Content-Type & \verb=null= oder \verb=application/x-www-from-urlencoded= & & 2 & 2 & 2\\
    \emph{Connection} & \verb=close= & & 1 & 1 & 1\\
    Content-Length & & & 117 & 117 & 382\\
    Payload & & & & 20105 & 14681\\
    \hline
      % \end{tabular}}
    \end{tabular}
