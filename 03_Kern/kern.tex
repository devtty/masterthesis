...
%  \resizebox{\textwidth}{!}{ 
  \begin{tabular}{llllll}
    ...
    \textbf{Name} & \textbf{Wert} & \textbf{Anmerkungen} & \multicolumn{3}{l}{\textbf{Distmiss}} \\
...
\textcolor{bhtGray}{\ding{110} Anmerkung:} Die letzten drei Spalten der Tabelle beinhalten 
Das WEKA-Tool unterstützt ein eigenes Format names \emph{\textbf{A}ttribute-\textbf{R}elation \textbf{F}ile \textbf{F}ormat} (ARFF) welches die Daten ggf. mit entsprechenden Datentypen genauer beschreiben könnte.
