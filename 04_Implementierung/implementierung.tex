...
\textcolor{bhtGray}{\ding{110} Beispiel:} 
...
\medskip
\small
Aufbau eines Entscheidungsbaums (j48) für die Klassifizierung mit den Daten aus dem CSIC2010-Datensatzes unter Verwendung der WEKA-Bibliothek.
\label{fig:wekatrain}
...
Für Erweiterungen von WebCastellum \emph{nach} die nach der regelbasierten Überprüfung ausgeführt werden, bietet sich die Methode \verb=doAfterProcessing= an. Hier kann dann entsprechend geprüft werden.\\
