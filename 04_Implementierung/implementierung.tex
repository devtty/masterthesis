...
\textcolor{bhtGray}{\ding{110} Beispiel:} Im folgenden
...
\medskip
\small
Beispiel einer Konfiguration - Die Anwendung identifiziert sich beim Abruf über eine eindeutige Identifikationsnummer (UUID), hier z.B. \url{https://devtty.de/wc/550e8400-e29b-11d4-a716-446655440000/config.json}
\label{fig:wekatrain}
